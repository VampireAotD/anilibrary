...
const voiceActing = computed(() => props.anime.voice_acting.map(voiceActing => voiceActing.name))
</script>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
          <section class="p-6 text-gray-600 body-font">
            <div class="container px-5 mx-auto flex flex-wrap">
              <div class="lg:w-1/4 h-1/3 mb-10 lg:mb-0 rounded-lg overflow-hidden">
                <img :src="anime.image.path" class="object-cover object-center h-full w-full" :alt="anime.title">
              </div>

              <div class="flex flex-col flex-wrap h-full lg:w-1/2 lg:pl-12 lg:text-left text-center">
                <div class="flex flex-col lg:items-start items-center">
                  <div class="flex-grow">
                    ...
                    <div class="mb-2">
                      ...
                      <div class="flex flex-wrap">
                        <span v-for="genre in genres" class="cursor-pointer text-neutral-400 hover:underline mr-1">
                          {{ genre }}
                        </span>
                      </div>
                    </div>
                    ...
                    <div class="mb-4">
                      ...
                      <div class="flex flex-wrap">
                        <span v-for="voiceActing in voiceActing"
